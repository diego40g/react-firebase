...
export const saveWebsite=(newLink)=>addDoc(collection(db,collectionName),newLink)
export const updateWebsite=(id,updatedFields)=>updateDoc(doc,(db,collectionName,id),updatedFields)
...
export const staticWeb=(data,uri)=>db.collection(collectionName).doc(uri).set(data)